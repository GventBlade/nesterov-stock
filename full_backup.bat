...
:: Вказуємо прямі слеші /, щоб Windows не ламала шлях
set KEY_PATH="C:/Users/vanno/Downloads/ssh-key-2026-08-20.key"
set SERVER_USER=ubuntu
set SERVER_IP=152.70.164.207
set REMOTE_DIR=/home/ubuntu/DjangoProject

:: Створення папки з датою
